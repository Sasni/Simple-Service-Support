 ...
 */
	...
	try {
		$config = array(
			'host' => 'localhost',  // propably localhost
			'user' => 'xxx', // db user
			'pass' => 'xxx', // db pass
			'db'   => 'xxx' // db name
			);
...
<!--<link href="css/style.css" rel="stylesheet" type="text/css" />--> 
    ...
    <!--<a href="http://www.tech-sas.pl"><img src="http://sasni.kylos.pl/tech-sas.pl/wp-content/uploads/2014/01/44x1003.png" alt="Logo TECH-SAS" title="Przejdź na strone główną"></a>-->
